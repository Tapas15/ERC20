...
contract AREVEAToken is ERC20, ERC20Burnable, Ownable {
  ...
  uint256 constant MAXIMUMSUPPLY=1000000000000*10**18; // in circulatoin 

  constructor() ERC20("AREVEA", "AVA") { 
      _mint(msg.sender, 1000000 * 10 ** 18); //can create maximum 
